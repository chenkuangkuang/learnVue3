...
L.TileLayer.ChinaProvider.providers = {
    TianDiTu: {
        ...
        key: "7620fff2bd318e4e46aa38cec608bd44"
    },
    ...
    GaoDe: {
        ...
        N2: {
            Map: 'http://webrd0{s}.is.autonavi.com/appmaptile?lang=zh_cn&size=1&scale=1&style=7&x={x}&y={y}&z={z}&ltype=2'
        },
        N3: {
            Map: 'http://cache1.arcgisonline.cn/ArcGIS/rest/services/ChinaOnlineStreetGray/MapServer/tile/{z}/{y}/{x}'
        },
        N1: {
            Map: 'http://cache1.arcgisonline.cn/ArcGIS/rest/services/ChinaOnlineStreetPurplishBlue/MapServer/tile/{z}/{y}/{x}'
        },
        N4: {
            Map: 'http://webrd0{s}.is.autonavi.com/appmaptile?lang=zh_cn&size=1&scale=1&style=8&x={x}&y={y}&z={z}&ltype=4'
        },
        Satellite: {
    ...
    mapgis: {
        Normal: {
            Map: "http://222.177.213.242:8002/igs/rest/mrms/docs/%E5%8C%97%E4%BA%AC%E5%B8%82_Java?f=png&w=512&h=512&guid=&cache=false&bbox=116.455078125,39.990234375,116.47705078125,40.01220703125",
        }
    }
